...
const ProfilePage = () => {
    const { authUser, isUpdatingProfile, updateProfile, checkAuth, deleteAccount } =
        useAuthStore();
    ...
    const handleImageUpload = async (e: unknown) => {
        ...
        reader.onload = async () => {
            ...
            setSelectedImg(base46Image as SetStateAction<null>);
            await updateProfile({ profilePic: base46Image });
        };
    };
    ...
    return (
        <>
            ...
            <dialog id="deleteModal" ref={deleteModalRef} className="modal">
